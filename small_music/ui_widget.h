...
"}"));
        ...
        song_name_lab_2 = new QLabel(widget_5);
        song_name_lab_2->setObjectName(QStringLiteral("song_name_lab_2"));
        song_name_lab_2->setFont(font1);
        song_name_lab_2->setStyleSheet(QLatin1String("QLabel\n"
"{\n"
"	background-color: transparent;\n"
"	color: rgb(0, 0, 0);\n"
"\n"
"}"));
        ...
        horizontalLayout_4->addWidget(song_name_lab_2);
...
""));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        song_name_lab_2->setText(QString());
